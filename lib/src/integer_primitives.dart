...
bool isValidIntString(String s,
        ...
        int minLength = 1,
        int maxLength = 20]) =>
    tryParseInt(s, start, end, minLength, maxLength) != null;
...
String hashIntegerString(String s) {
...
/// Returns a [List<String>] containing the hash of [sList].
List<String> hashIntegerStringList(List<String> sList) =>
    sList.map(hashIntegerString);
*/
